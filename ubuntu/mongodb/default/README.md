...
To create the image `ciyinhuang/ubuntu-mongodb`, execute the following command on the tutum-mongodb folder:

        docker build -t ciyinhuang/ubuntu-mongodb .
...
Run the following command to start MongoDB:
        ...
        docker run -d -p 27017:27017 -p 28017:28017 ciyinhuang/ubuntu-mongodb
...
set the environment variable `MONGODB_PASS` to your specific password when running the container:
        ...
        docker run -d -p 27017:27017 -p 28017:28017 -e MONGODB_PASS="mypass" ciyinhuang/ubuntu-mongodb
